...
parse.add_argument('--image_path', type = str, default='./data/data19',help = "image path")
...
with torch.no_grad():
    ...
    checkpoint = torch.load("pretrained/best_model_frame{}_num_head8.pth".format(args.Frames), map_location="cuda")
    ...
    for _ in tqdm(datalist):
        ...
        res,attn,top5 = model(input.unsqueeze(dim = 0).cuda())
